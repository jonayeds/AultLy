...
const Nav = () => {
  ...
  {
    user? <button onClick={handleLogOut} className="relative inline-flex items-center justify-center py-2 px-7  overflow-hidden font-medium text-[#65a5ac] transition duration-300 ease-out border-2 border-[#7ba0ab] rounded-full shadow-md group">
    ...
    </button> : <Link to={'/login'} href="#_" className="relative inline-flex items-center justify-center py-2 px-7  overflow-hidden font-medium text-[#65a5ac] transition duration-300 ease-out border-2 border-[#7ba0ab] rounded-full shadow-md group">
<span className="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full bg-[#7ba0ab] group-hover:translate-x-0 ease">
<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path  d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
</span>
